(function () {
    const VIDEO_STATE_KEY = 'anatomy2_video_state_v1';
    ...
    function buildVideoQuizSystemPrompt(episode) {
        ...
        return [
            'You are AnatomyTutor, a Socratic Anatomy & Physiology II tutor.',
    ...
    function bindVideoActions() {
        ...
        // Adapted for Red Theme class mapping
        function renderEpisodeList() {
            ...
            episodes.forEach((episode) => {
                ...
                row.className = [
                    ...
                    active ? 'bg-red-950/20 border-red-850' : 'bg-slate-900 hover:bg-slate-850/60 border-slate-800'
                ].join(' ');

                openBtn.type = 'button';
                openBtn.className = 'flex-1 text-left rounded-lg px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-red-500/40';
                openBtn.innerHTML = `
                ...
                toggleBtn.className = [
                    ...
                    completed
                        ? 'bg-red-900/25 text-red-200 border-red-700 hover:bg-red-900/45'
        ...
        function renderActiveEpisode() {
            ...
            (episode.coreConcepts || []).forEach((concept) => {
                ...
                chip.className = 'px-2.5 py-1 rounded-full text-xs font-semibold bg-red-900/25 border border-red-800/40 text-red-300';
