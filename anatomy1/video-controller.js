(function () {
    const VIDEO_STATE_KEY = 'anatomy1_video_state_v1';
    ...
    function buildVideoQuizSystemPrompt(episode) {
        ...
        return [
            'You are AnatomyTutor, a Socratic Anatomy & Physiology I tutor.',
    ...
    function bindVideoActions() {
        ...
        function renderEpisodeList() {
            ...
            episodes.forEach((episode) => {
                ...
                row.className = [
                    ...
                    active ? 'bg-rose-950/20 border-rose-850' : 'bg-slate-900 hover:bg-slate-850/60 border-slate-800'
                ].join(' ');

                openBtn.type = 'button';
                openBtn.className = 'flex-1 text-left rounded-lg px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-rose-500/40';
                openBtn.innerHTML = `
                ...
                toggleBtn.className = [
                    ...
                    completed
                        ? 'bg-rose-900/25 text-rose-200 border-rose-700 hover:bg-rose-900/45'
        ...
        function renderActiveEpisode() {
            ...
            (episode.coreConcepts || []).forEach((concept) => {
                ...
                chip.className = 'px-2.5 py-1 rounded-full text-xs font-semibold bg-rose-900/25 border border-rose-800/40 text-rose-300';
